...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="champs-persos">
			...
			$lieux = get_post_meta($post->ID, 'lieux', true);
			$type = get_post_meta($post->ID, 'type', true);
			?>

			<?php if(false === empty($duree)): ?>
			<span class="champs-persos-item">
			<i class=”champs-persos-label”><br />Durée : </i>
			<?php echo $duree ?></span>
			<?php endif; ?>

			<?php if(false === empty($realisateur)): ?>
			<span class="champs-persos-item">
			<i class=”champs-persos-label”><br />réalisateur(s) : </i>
			<?php echo $realisateur ?></span>
			<?php endif; ?>
			
			<?php if(false === empty($acteurs)): ?>
			<span class="champs-persos-item">
			<i class=”champs-persos-label”><br />Interprètes : </i>
			<?php echo $acteurs ?></span>
			<?php endif; ?>

			<?php if(false === empty($annee)): ?>
			<span class="champs-persos-item">
			<i class=”champs-persos-label”><br />Année : </i>
			<?php echo $annee ?></span>
			<?php endif; ?>

			<?php if(false === empty($langue)): ?>
			<span class="champs-persos-item">
			<i class=”champs-persos-label”><br />Langue : </i>
			<?php echo $langue ?></span>
			<?php endif; ?>

			<?php if(false === empty($lieux)): ?>
			<span class="champs-persos-item">
			<i class=”champs-persos-label”><br />Lieux : </i>
			<?php echo $lieux ?></span>
			<?php endif; ?>

			<?php if(false === empty($type)): ?>
			<span class="champs-persos-item">
			<i class=”champs-persos-label”><br />Type : </i>
			<?php echo $type ?></span>
			<?php endif; ?>
